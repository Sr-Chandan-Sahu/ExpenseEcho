  ...
  return (
    <div className='w-full flex items-center justify-between py-6'>
      <div className='flex items-center gap-2 cursor-pointer'>
        <div className='w-10 h-10 ms:w-12 md:h-12 flex items-center justify-center bg-violet-700 rounded-xl'>
          <RiCurrencyLine className='text-white text-3xl hover:animate-spin'/>
        </div>
        <span className='text-xl font-bold text-black dark:text-white'>ExpenseEcho</span>
      </div>
      ...
      <div className='flex items-center gap-10 2xl:gap-20'>
        ...
        <div className='flex items-center gap-2'>
          <img src={Avatar} alt="User" className='w-10 md:w-12 h-10 md:h-12 rounded-full object-cover cursor-pointer'/>
