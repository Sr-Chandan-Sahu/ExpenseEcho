    ...
    <div className='flex flex-col md:flex-row items-center justify-between gap-8 2xl:gap-30 mb-20'>
      {data.map((item, index) => (
        <div
          ...
          className='w-full max-w-lg flex items-center justify-between gap-5 px-4 md:px-8 py-12 rounded-lg bg-gray-50 dark:bg-slate-800 border border-gray-100 dark:border-slate-900'
        >
          <div className='flex items-center gap-2'>
            ...
            <div className='space-y-3 ml-2'>
              <span className='text-gray-600 font-semibold dark:text-gray-400 text-base md:text-lg'>
                {item.label}
              </span>
